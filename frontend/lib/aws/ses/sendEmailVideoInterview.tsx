    ...
    const emailHtml = `    <div style="background-color: #9bb4dd; padding: 20px; font-family: Arial, sans-serif; color: #333;">
        <div
            ...
            <p style="font-size: 16px; line-height: 1.6; color: #666;">
                I hope you're doing well! I'm conducting a reference check for Alex Chan, who worked with you at Shopify. Could you kindly confirm if you collaborated with him? I'd also appreciate your feedback on his strengths, growth areas, work style, and any challenges you encountered. Thanks!
            </p>
